 ...
 */
public class RadioSendRequestsLabJPanel extends javax.swing.JPanel {

    /**
     * Creates new form RadioSendRequestsLabJPanel
     */
    ...
    public RadioSendRequestsLabJPanel(JPanel userProcessContainer, UserAccount userAccount, Organization organization, Enterprise enterprise) {
        initComponents();
    ...
    private void labComboBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_labComboBoxActionPerformed
        ...
        if (organization instanceof NeurologyLabOrganization
            || organization instanceof CardiologyLabOrganization || organization instanceof CancerLabOrganization){
